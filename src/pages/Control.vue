...
<template>
  ...
  <div class="relative w-full h-full p-8 text-white overflow-hidden flex flex-col">
    ...
    <div class="h-40 grid grid-cols-12 gap-6">
       <!-- Left Control Panel -->
       <div class="col-span-4 h-full">
          <BaseCard className="h-full !border-white/5 !rounded-3xl p-6 flex flex-col gap-4">
             <div class="text-xl font-bold tracking-wide mb-2">窗帘控制</div>
             <div class="flex-1 flex items-center justify-around px-8 bg-white/5 rounded-3xl">
                <button class="p-4 hover:bg-white/10 rounded-full active:scale-95"><ChevronLeft class="w-8 h-8" /></button>
                <button class="p-6 border border-white/20 rounded-full hover:bg-white/10 active:scale-95"><Pause class="w-8 h-8" /></button>
                <button class="p-4 hover:bg-white/10 rounded-full active:scale-95"><ChevronRight class="w-8 h-8" /></button>
             </div>
          </BaseCard>
       </div>
